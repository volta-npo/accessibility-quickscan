export const v3 = {
  ...
  "capabilities": [
    "Domain-specific workbench: Accessibility Triage Board",
    "Operational table: Accessibility issues",
  ...
  "releaseChecklist": [
    ...
    "Accessibility Health reaches production threshold",
    "Blocker Risk is documented with evidence",
    "Retest Coverage has no unresolved blocker",
    "Issue report verified",
    "Accessibility backlog CSV verified",
    "Before/after fix log verified"
  ],
  "operations": [
