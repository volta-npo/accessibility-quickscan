//! Rust release-gate engine for Accessibility QuickScan.
//!
...
pub const PRODUCT_SLUG: &str = "accessibility-quickscan";
pub const PRODUCT_TITLE: &str = "Accessibility QuickScan";
