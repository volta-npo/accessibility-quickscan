# Security Policy: Accessibility QuickScan
...
- For this product's domain, review these gates before handoff: Critical blockers cannot be complete without retest, Contrast ratio numeric, Every issue needs page and fix text.
