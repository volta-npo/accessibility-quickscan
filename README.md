...
**Digital Presence** · **Repo 09/50** · **No backend. No login. Client data stays local.**
...
**Accessibility QuickScan** is a polished, local-first open-source tool from Volta's 50-project OSS division. It helps Students and mentors performing pre-handoff QA turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
